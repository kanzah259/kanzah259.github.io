...
const Footer = ({isDarkMode}: FooterProps) => (
    ...
    <div>
        <div className="text-center snap-start">
            <div className="border-t dark:border-[#00FFFF] border-[#111111] bottom-2"></div>
            <h4 className="font-orbitron dark:text-[#E0E0E0] text-[#111111] font-bold text-[16px] pt-1">© 2025 Kanzah Hussain all rights reserved</h4>
